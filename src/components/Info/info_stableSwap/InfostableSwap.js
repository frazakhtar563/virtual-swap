      ...
      <div className="row">
        <div className="col-md-12">
          <div className="row d-flex justify-content-center mt-5">
            <div className="col-lg-7 col-md-12 d-flex justify-content-around  info-stable-responsive">
              <div className="">
              ...
              <div className="btn-nft-responsive">
            ...
            <div className="col-md-12 mt-5">
              <div className="row d-flex ">
                <div className="col-md-12  d-flex justify-content-start align-items-center">
                  <div className="t-top-tokens me-4">Transactions</div>
...
export default info_stableSwap;
